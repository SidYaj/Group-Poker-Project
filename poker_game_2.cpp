...
int poker_game_2(int rng){ // function for the match against the 2nd CPU
    std::srand(rng);
    std::string pause;
    Player *p1 = new Player(400, 1);
    Player *p2 = new Player(400, 2);
    Community C;
    p1->next = p2;
    p2->next = p1;
    bool x = rand() % 2;
    ...
    for(int round = 1; round <= 4; round++){
        ...
        std::cout << std::endl;
        if(p1->is_dealer){
            std::cout << "You are the small blind posting $20." << std::endl;
            std::cout << "CPU is the big blind posting $40." << std::endl;
        }
        else{
            std::cout << "You are the big blind posting $40." << std::endl;
            std::cout << "CPU is the small blind posting $20." << std::endl;
        }
        bool flag = true;
        while(flag == true){
            ...
            if(current == p1){
                std::cout << "\nYour turn: " << std::endl;
                make_player_choice_C(current, flag);
            }
            else {
                std::cout << "\nCPU's turn: ";
                make_cpu_choice_C(current, flag, rand());
            }
            current = current->next;
        }
        std::cout << std::endl;
        ...
        while(flag == true){
            ...
            if(current == p1){
                std::cout << "\nYour turn: " << std::endl;
                make_player_choice_D(current, flag);
            }
            else {
                std::cout << "\nCPU's turn: ";
                make_cpu_choice_D(current, C, flag, rand());
            }
            current = current->next;
        }
        std::cout << std::endl;
